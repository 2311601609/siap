...
<table cellspacing="0" cellpadding="1" style="border: 1px solid #000;font-size:12px; width: 100%;">
    ...
    <tbody>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">LABA (RUGI) KOTOR</td>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">TOTAL BEBAN USAHA</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">LABA (RUGI) USAHA</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">TOTAL PENDAPATAN (BEBAN) LAIN-LAIN</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">LABA (RUGI) SEBELUM BEBAN PAJAK PENGHASILAN</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
            <td style="background-color: #72A0C1;text-align:right;">{{ number_format($total1 - $total2 + $total3) }}</td>
            <td style="background-color: #72A0C1;text-align:right;">{{ number_format($total1_sd - $total2_sd + $total3_sd) }}</td>
        </tr>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">TOTAL BEBAN PAJAK PENGHASILAN</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">TOTAL LABA ANAK PERUSAHAAN</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
        ...
        <tr>
            <td style="background-color: #72A0C1;text-align:center;" colspan="2">LABA (RUGI) BERSIH</td>
            <td style="background-color: #72A0C1;text-align:right;">0</td>
            <td style="background-color: #72A0C1;text-align:right;">{{ number_format($total1 - $total2 + $total3 - $total4 + $total5) }}</td>
            <td style="background-color: #72A0C1;text-align:right;">{{ number_format($total1_sd - $total2_sd + $total3_sd - $total4_sd + $total5_sd) }}</td>
        </tr>
