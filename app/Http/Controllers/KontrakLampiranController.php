...
class KontrakLampiranController extends Controller
{
	protected $table;
							...
							$aksi = '
								<center>
									...
									<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 38px, 0px); top: 0px; left: 0px; will-change: transform;">
										...
										<a id="'.$row->id.'" class="dropdown-item" href="kontrak-lampiran/download?nmfile='.$row->nmfile.'" target="_blank">Unduh Data</a>
									</div>
								</center>';
						}
	...
	public function download()
	{
		if(isset($_GET['nmfile'])){
			if($_GET['nmfile']!==null && $_GET['nmfile']!==''){
				...
				$path = 'public/kontrak/' . $_GET['nmfile'];
